<template>
  <!--This page was made by Aaron, please refer to his code for more details-->
  <div class="calculator">
    ...
    <p
      ...
      title="Total to pay off loan with interest"
      class="payment"
    >
